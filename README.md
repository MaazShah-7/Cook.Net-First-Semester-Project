# 🍳 Cook.Net - Your Personal Kitchen Guide
...
* **Categorization:** Organize recipes into logical sections like Main Course, Desserts, and Drinks.
* **Visual Resources:** Includes a dedicated image management system for recipe thumbnails.

## 🛠️ Built With
* **C#** - Primary programming language.
* **Windows Forms (WinForms)** - UI Framework for a native Windows experience.
* **.NET Framework** - Core development platform.
